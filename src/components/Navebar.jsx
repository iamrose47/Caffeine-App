...
const [openmenu,setOpenmenu] = useState(false)
  ...
  return (
    ...
    <div className="flex justify-between items-center border-[.1rem] border-white max-sm:px-[2rem] px-[1.2rem] text-white">
      <h1 className="cursor-pointer max-sm:text-[3rem] text-[2.5rem] font-fonts font-bold">
        Caffeine
      </h1>
      ...
      <ul className=" list-none font-sans text-[1.2rem] max-sm:text-[5rem] max-sm:flex flex-col items-center">
        <li className="inline-block mx-[1rem]">
          <a href="#home" onClick={() => setOpenmenu(!openmenu)} className="font-bold">
            Home
          </a>
        </li>
        <li className="inline-block mx-[1rem]">
          <a href="#about" onClick={() => setOpenmenu(!openmenu)} className="font-bold">
            About Us
          </a>
        </li>
        <li className="inline-block mx-[1rem]">
          <a href="#menu" onClick={() => setOpenmenu(!openmenu)}className="font-bold">
            Menu
          </a>
        </li>
        <li className="inline-block mx-[1rem]">
          <a href="#contect" onClick={() => setOpenmenu(!openmenu)}className="font-bold">
            Contact
          </a>
        </li>
      ...
      <div className='max-sm:hidden block'>
        <div className=" flex gap-[.6rem]">
          <h1 className="cursor-pointer border-r-[.1rem] border-white text-[1.2rem] pr-[.7rem] font-bold">
            Sign In
          </h1>
